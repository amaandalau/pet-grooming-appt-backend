...
CREATE TABLE timeslots(
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY(id),
    FOREIGN KEY (groomer_id) REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE appt_services(
    ...
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
    FOREIGN KEY (appt_id) REFERENCES appointments(id) ON UPDATE CASCADE ON DELETE CASCADE,
